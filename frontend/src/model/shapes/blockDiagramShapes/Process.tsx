    ...
    render(handlerMouseDown: (e: React.PointerEvent<SVGGeometryElement>) => void,
        ...
        return <path
            ...
            d={`
                ...
                l 0 -${this.config.graphicalProperties[GraphicalPropertyTypes.HEIGHT].value}
                l -${this.config.graphicalProperties[GraphicalPropertyTypes.WIDTH].value} 0
                m ${+this.config.graphicalProperties[GraphicalPropertyTypes.HEIGHT].value * 0.15} 0
                l 0 ${this.config.graphicalProperties[GraphicalPropertyTypes.HEIGHT].value}
                m ${+this.config.graphicalProperties[GraphicalPropertyTypes.WIDTH].value - +this.config.graphicalProperties[GraphicalPropertyTypes.HEIGHT].value * 0.3} 0
                l 0 -${this.config.graphicalProperties[GraphicalPropertyTypes.HEIGHT].value}
                `}
        />
    }
