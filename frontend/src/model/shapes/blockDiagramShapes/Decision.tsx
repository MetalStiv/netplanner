...
class Decision implements IShape {
    ...
    render(handlerMouseDown: (e: React.PointerEvent<SVGGeometryElement>) => void,
        ...
        return <path
            ...
            d={`
                M ${+this.config.graphicalProperties[GraphicalPropertyTypes.X].value + +this.config.graphicalProperties[GraphicalPropertyTypes.WIDTH].value / 2},
                    ${this.config.graphicalProperties[GraphicalPropertyTypes.Y].value} 
                l -${+this.config.graphicalProperties[GraphicalPropertyTypes.WIDTH].value / 2} ${+this.config.graphicalProperties[GraphicalPropertyTypes.HEIGHT].value / 2}
                l ${+this.config.graphicalProperties[GraphicalPropertyTypes.WIDTH].value / 2} ${+this.config.graphicalProperties[GraphicalPropertyTypes.HEIGHT].value / 2}
                l ${+this.config.graphicalProperties[GraphicalPropertyTypes.WIDTH].value / 2} -${+this.config.graphicalProperties[GraphicalPropertyTypes.HEIGHT].value / 2}
                l -${+this.config.graphicalProperties[GraphicalPropertyTypes.WIDTH].value / 2} -${+this.config.graphicalProperties[GraphicalPropertyTypes.HEIGHT].value / 2}
                `}
