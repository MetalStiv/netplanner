    ...
    render(handlerMouseDown: (e: React.MouseEvent<SVGGeometryElement>) => void,
        ...
        return <path
            ...
            d={`
                ...
                m -${+this.config.graphicalProperties[GraphicalPropertyTypes.WIDTH].value} -${+this.config.graphicalProperties[GraphicalPropertyTypes.HEIGHT].value * 0.95}
                a ${this.config.graphicalProperties[GraphicalPropertyTypes.WIDTH].value} ${+this.config.graphicalProperties[GraphicalPropertyTypes.HEIGHT].value * 0.95}
                    0 0 0 ${+this.config.graphicalProperties[GraphicalPropertyTypes.WIDTH].value} ${+this.config.graphicalProperties[GraphicalPropertyTypes.HEIGHT].value * 0.95}
