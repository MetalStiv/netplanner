...
const LayersPanel = ({ layersSet, updateLayersCallback }: ILayersPanelProps) => {
        ...
        <div id="layersPanel">
            <p className="panel-title">
                ...
                <div className="plus" onClick={() => {
                    projectStore.getProjects().at(0)?.getPages().at(0)?.addLayer();
                    updateLayersCallback(projectStore.getProjects().at(0)?.getPages().at(0)?.getLayers()!)
                }
                }>
