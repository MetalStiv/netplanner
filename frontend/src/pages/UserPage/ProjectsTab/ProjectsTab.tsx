                                ...
                                <div className={projectsMetaStore?.getData()
                                    ...
                                    <button id="add-btn-project" type="submit" className="" onClick={addProject}>
                                        <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1.65405 9.74756H18.3458" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M10 17.1747V2.32031" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </button>
                                    <button id="add-btn-group" type="submit" className="" onClick={addProjectGroup}>
                                        <svg width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d={"M3.06182 8.06909H2.62546C2.56873 8.06909 2.512 8.06909 2.45527 8.06909H2.40073L2.28946 " +
                                                ...
                                                " 19.7202 1.43694 19.3421 1.43636 18.9476V9.70109Z"} strokeWidth="2" />
                                        </svg>
                                    </button>
                                </div>
                            </div>
